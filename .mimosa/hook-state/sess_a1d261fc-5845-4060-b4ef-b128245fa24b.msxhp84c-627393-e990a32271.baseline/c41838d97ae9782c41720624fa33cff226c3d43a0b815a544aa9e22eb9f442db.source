 ...
 * ({@code code/01_platform/02_sql/ddl/12_execution_attempts.sql} v2). Pinned
 ...
 * R-234). The column-ownership matrix ({@link ExecutionAttemptsColumnOwnership})
 * consumes this layout so ownership indexes can never drift from the DDL.
 */
public final class ExecutionAttemptsColumns {
    ...
    public static final List<String> TYPE_ROOTS = List.of(
            ...
            "BIGINT", "BIGINT", "STRING", "INTEGER", "STRING");

    /** DDL nullability per column (12 DDL v2). */
