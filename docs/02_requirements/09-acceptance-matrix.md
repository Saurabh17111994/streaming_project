...
| `AC-FLS-011` | REQ-FLS-003 | Full | — | DDL → requirement parity scan for all 20 tables | Every table has DECIDED, EVIDENCE-GATED, or NOT APPLICABLE type status; DDL matches declared type and owner | `test/storage/table-type-decision/` report | `NOT_IMPLEMENTED` |
