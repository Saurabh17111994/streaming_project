...
| Executable tests | Ingestion suites executable and green: 247 ingestion + 466 common (2026-08-25 CHG-102 re-verified; raw surefire 469 minus 2 gated `FlussBundleReader*` reports); plus offline 2026-08-24: ActionCaptureContractTest 9/9, BabysitterContractTest 5/5, SignalHarnessContractTest 4/4, ExecutorOfflineContract 4/4, SyntheticWorkloadTest 3/3, PositionProjectorTest 12/12, FingerprintDedupFunctionTest 15/15 — total offline 22 new + 27 existing = 49 green deterministic without market/4VM. Cargo **206/206** (nautilus-execution-service, CHG-106: +10 amend tests; was 196/196) clippy/fmt/vet clean. |
