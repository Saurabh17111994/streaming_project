...
> writable by the gateway's raw Fluss client. The live COMPAT-FLUSS-005 matrix and a scratch
> append/lookup for both production-shaped tables remain required before deployment.
>
