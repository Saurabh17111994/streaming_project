...
- [x] All DDLs have checksums and compatibility classes. ✓ `schema_manifest.json` (26 tables as of 2026-08-15 — 21 at authoring, +`fingerprint_dedup` +`trade_instruction_state` +`eod_offload_state`, SHA-256 per file), `ddl_apply.py` validates checksums (SCH-01, SCH-02)
