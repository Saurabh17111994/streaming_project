...
| `CepDependencyGuardTest` | 1 | SIG-UNIT-007 dependency scan (landed 2026-08-16): no CEP dependency declaration or import in the module pom.xml or java/scala sources — in-suite mirror of the `cep_guard.sh` gate (the guard test never spells the forbidden literals in its own source) |
