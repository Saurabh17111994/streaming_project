...
10. Forming-bar data passed directly to business logic in the same Signal job; not written and re-read through Fluss for ranking (REQ-FC-007 preserved; the durable forming-bar KV projection — implemented 2026-08-16 — is Fluss-owned).
