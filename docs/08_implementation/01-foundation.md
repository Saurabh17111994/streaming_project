...
- [x] Fluss/Flink capability tests pass for the selected versions. ✓ fresh full runs 2026-08-13: common 112/0/0, ingestion 180/0/7 skipped, compute 184/0/12 skipped; re-measured 2026-08-14: ingestion **192/0/7 skipped**, compute **185/0/13 skipped** (ingestion corrected to **188** after the 2026-08-14 Standard-feed test deletion); gated battery 10/10; `SignalJobSavepointRestoreIntegrationTest` green (strict restore + 2× rescale, real dedup state).
